...
public class TradeTests {
    ...
    public void generateTradeTest() throws ExecutionException, InterruptedException {
        // Issuer sends trade
        trade = new TradeState(new UniqueIdentifier(), offer, new Date(), new Date(),broker1, broker1, issuer, "arranger",100, 1,100, 123, Currency.getInstance("USD"), State.PROPOSED, new Date());
